...
with {
    ...
    // all the way is the best, bu YMMV. I leave this here as an indicator  //
    ...
    excitation     = no.colored_noise(8,exc_col_noi)*adj_gain*exc_env*exc_window : exc_filt;
    /////////////////////////////////////
    ...
    hass_delay     = hslider("hass_delay[midi:ctrl 41]",0.03,0.00,0.04,0.00031496);
